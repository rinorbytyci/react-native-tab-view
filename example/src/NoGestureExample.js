...
export default class NoGestureExample extends React.Component<*, State> {
  static title = 'No gestures';
  ...
  _renderItem = ({ navigationState, position, layout }) => ({
    route,
    index,
  }) => {
    const isFocused = navigationState.index === index;

    let activeOpacity, inactiveOpacity;
    ...
    if (layout.width) {
      ...
      // If we don't have layout yet, don't interpolate on position
