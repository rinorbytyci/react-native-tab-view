...
import type { Scene, Route, NavigationState, Layout } from './types';
import type {
  ViewStyleProp,
  TextStyleProp,
...
export default function TabBarItem<T: Route>({
  ...
  const opacity = layout.width
    ...
    : // When we don't have the layout, don't use animated opacity values
      // Otherwise it'll be incorrect due to position being not calculated yet
      isFocused
      ? activeOpacity
      : inactiveOpacity;
